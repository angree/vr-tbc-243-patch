...
// Pass-through wrappers for the Direct3D 9 device interfaces.
//
// Every method below is a straight re-declaration of Microsoft's
// IDirect3DDevice9 / IDirect3DDevice9Ex COM interfaces (see the Windows SDK
// d3d9.h). To subclass a COM interface the derived class MUST repeat the exact
// vtable signatures, so this list is fixed by the platform and carries no
// expression original to this project or any third party. All the VR-specific
// behaviour lives in the .cpp; the header is just the required interface shape.

class cIDirect3DDevice9 final : public IDirect3DDevice9
{
public:
...
class cIDirect3DDevice9Ex final : public IDirect3DDevice9Ex
{
public:
